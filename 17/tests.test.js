...
import {code, parseInput, adv, bxl} from "./code.js";
...
test('part1: e1', () => {
    const result = code(`Register A: 0
Register B: 0
Register C: 9
...
test('part1: e2', () => {
    const result = code(`Register A: 10
Register B: 0
Register C: 0
...
test('part1: e3', () => {
    const result = code(`Register A: 2024
Register B: 0
Register C: 0
...
test('part1: example1', () => {
    const result = code(example1);
    assert.deepEqual(result[0], '4,6,3,5,6,3,5,2,1,0');
});

test('part1: real', () => {
    const result = code(realInput);
